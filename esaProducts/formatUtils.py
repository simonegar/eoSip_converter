...
def addSecondsSpot(product_date,cfg_seconds,cfg_milliseconds):
        print "======================================date is %s" %(product_date)
        x=product_date + timedelta(seconds=cfg_seconds, milliseconds=cfg_milliseconds)
        return x
        
def subSecondsSpot(product_date,cfg_seconds,cfg_milliseconds):
        print "======================================date is %s" %(product_date)
        x=product_date - timedelta(seconds=cfg_seconds, milliseconds=cfg_milliseconds)
        return x
